"""
Given a hierarchical directory structure with one root folder and folders containing either files or subfolder,
write a function which traverses the folder and prints the contents starting with the deepest level first.
Print both the folder/file name and the object type (file or folder).
"""
